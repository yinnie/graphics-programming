...
void setup() {
  ...
  cube = meshFactory.createCube (meshPointsU, 50);
...
void draw() {
  ...
  cube.setPosition(new PVector(width/2, height/2, 0));
  cube.draw();
  cube.setRotation( new PVector( QUARTER_PI*mouseX/4, QUARTER_PI*mouseX/4, 0.0 ) ) ;
